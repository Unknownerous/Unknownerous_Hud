...
function health(num){$(".health .fill").attr("style","height:"+num+"%");}
function armour(num){$(".armour .fill").attr("style","height:"+num+"%");}
function food(num){$(".food .fill").attr("style","height:"+num+"%");}
function water(num){$(".water .fill").attr("style","height:"+num+"%");}
...
function engine(num) {$(".engine .fill").attr("style","height:"+num+"%");}
function fuel(num){$(".fuel .fill").attr("style","height:"+num+"%");}
...
window.addEventListener('message', function(event) {
    ...
    if (data.status === 'identity') {
        document.getElementById('rp-name').textContent = data.data.name || 'Inconnu';
        document.getElementById('rp-age').textContent = (data.data.age || 'Inconnu') + " ans";
    }
});
